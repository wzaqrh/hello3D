...
public:
	MIR_MAKE_ALIGNED_OPERATOR_NEW;
	CoTask<bool> CreateAiScene(Launch launchMode, AiScenePtr& aiScene, ResourceManager& resourceMng, const std::string& assetPath, const std::string& redirectRes) ThreadSafe;
};
