...
#define DEBUG_CHANNEL_CLEARCOAT_FACTOR 81
#define DEBUG_CHANNEL_CLEARCOAT_ROUGHNESS 82
#define DEBUG_CHANNEL_CLEARCOAT_FRESNEL 83

#if !defined DEBUG_CHANNEL
	#define DEBUG_CHANNEL DEBUG_CHANNEL_CLEARCOAT_FACTOR
#endif
