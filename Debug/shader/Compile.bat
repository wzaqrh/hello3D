...
fxc "%MACRO%" /T "%PS_VERSION%" /Fo Model_PSAdd.cso /E PSAdd Model.fx
fxc "%MACRO%" /T "%VS_VERSION%" /Fo Model_VSShadowCaster.cso /E VSShadowCaster Model.fx
fxc "%MACRO%" /T "%PS_VERSION%" /Fo Model_PSShadowCaster.cso /E PSShadowCaster Model.fx
